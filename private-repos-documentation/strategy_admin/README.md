# lucas152112/strategy_admin

**Description**: 管理後台

**Primary Language**: Vue

**Created**: 2025-01-29T22:01:06Z
...
|----------|-------|------------|
| Vue | 248,990 | 61.0% |
| TypeScript | 147,155 | 36.0% |
| HTML | 5,374 | 1.3% |
| SCSS | 2,910 | 0.7% |
| JavaScript | 2,852 | 0.7% |
| Shell | 953 | 0.2% |
| CSS | 117 | 0.0% |

## Repository Information

- **GitHub URL**: https://github.com/lucas152112/strategy_admin
- **SSH URL**: git@github.com:lucas152112/strategy_admin.git
- **Clone URL**: https://github.com/lucas152112/strategy_admin.git
